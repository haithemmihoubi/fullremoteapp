...
class MobileMayout extends StatefulWidget {
  const MobileMayout({Key? key}) : super(key: key);

  @override
  State<MobileMayout> createState() => _MobileMayoutState();
}

class _MobileMayoutState extends State<MobileMayout> {
  @override
                                  ...
                                  Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ScalableText(
                                          text: 'La performance De vos joueurs',
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 5,
                                          ),
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: ColorsScheme.pink.withOpacity(0.1),
                                          shape: BoxShape.rectangle,
                                        ),
                                      ),
                                      Container(
